...
import { MdMailOutline, MdOutlineLockOpen, MdFace } from "react-icons/md";

const LoginSignUp = () => {
    const dispatch = useDispatch();
    const alert = useAlert();
    const { loading, error, isAuthenticated, loginRegisterSuccess } =
    ...
    const [avatar, setAvatar] = useState(ProfilePreview);
    ...
    useEffect(() => {
        ...
        if (loginRegisterSuccess) {
            alert.success(loginRegisterSuccess);
        }
